...
(define-irc-reply MSG-NICK NICKNAME ("([^ ]+)( (.*))?" NICKNAME NIL HOPCOUNT))
...
(define-irc-reply RPL-INVITING 341 ("([^ ]+) ([^ ]+)" NICKNAME CHANNEL))
...
(define-irc-reply RPL-WHOREPLY 352 ("([^ ]+) ([^ ]+) ([^ ]+) ([^ ]+) ([^ ]+) ([^*@+ ]+\\*?[@+]?) (:.*)" CHANNEL USERNAME HOST SERVER NICKNAME HG INFO))
...
(define-irc-reply ERR-USERNOTINCHANNEL 441 ("([^ ]+) ([^ ]+) (:.*)" NICKNAME CHANNEL INFO))
(define-irc-reply ERR-NOTONCHANNEL 442 ("([^ ]+) (:.*)" CHANNEL INFO))
(define-irc-reply ERR-USERONCHANNEL 443 ("([^ ]+) ([^ ]+)( :(.*))?" NICKNAME CHANNEL NIL INFO))
...
(define-irc-reply RPL-KNOCK 710 ("([^ ]+) ([^!]+)!([^@]+)@([^ ]+) (:.*)" CHANNEL NICKNAME USERNAME HOST INFO))
