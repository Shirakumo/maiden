...
(define-irc-reply MSG-NOTICE NOTICE ("([^ ]+)? ?:(.*)" NICKNAME MESSAGE) (message-event))
...
(define-irc-reply MSG-ERROR ERROR (":(.*)" MESSAGE) (message-event))
(define-irc-reply MSG-AWAY AWAY ("(:(.*))?" NIL MESSAGE) (message-event))
